...
sqlite3 $DB "SELECT '{\"tags\":[' || group_concat(json_object('pid',NORM_name,'tagname',tagname,'NORM_name',NORM_name,'tagtype',tagtype,'karas', karas, 'karacount', karacount)) || ']}' FROM all_tags ORDER BY tagtype, tagname;"
