...
sqlite3 $DB "SELECT '{\"series\":[' || group_concat(json_object('name',name,'NORM_name',NORM_name,'aliases',altname,'i18n',serie_i18n, 'karas', karas, 'karacount', karacount)) || ']}' FROM all_series ORDER BY name;"