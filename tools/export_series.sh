...
sqlite3 $DB "SELECT '{\"series\":[' || group_concat(json_object('seriename',seriename,'NORM_name',NORM_name,'aliases',altname,'i18n',serie_i18n, 'karas', karas)) || ']}' FROM all_series ORDER BY seriename;"